...
from .api import register, login_api, login_token, change_password, change_email, verify_email, resend_email_verification, get_avatar
...
urlpatterns = [
    ...
    path("api/get_avatar/", get_avatar, name="api_get_avatar"),
